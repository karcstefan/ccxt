...
class litebit extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        $markets = $this->publicGetTradeMarket ($params);
        $results = array();
    ...
    public function fetch_order_book($symbol, $limit, $params = array ()) {
        ...
        $orderBook = $this->publicGetTradeMarketCodeBook ($request);
        $results = array();
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        $this->load_markets();
        return $this->fetch_tickers([$symbol], $params);
    }
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        ...
        for ($i = 0; $i < count($this->markets); $i++) {
            ...
            if ($symbols === null || mb_strpos($symbols, $marketData->id)) {
                $ticker = $this->publicGetTradeMarketCodeHistory (array( 'code' => $marketData->id ));
    ...
    public function fetch_balance() {
        $balances = $this->privateGetBalance ();
        $free = array();
        $used = array();
        $total = array();
    ...
    public function cancel_order($params = array ()) {
        ...
        return $this->privateDeleteTradeOrderUuid ($request);
    }

    public function fetch_order($id, $symbol = null, $params = array ()) {
        $response = $this->privateGetTradeOfferUuid (array( 'uuid' => $id ));
        return $this->transform_order_data($response->data);
    }

    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        $response = $this->privateGetTradeOffer ();
        $output = array();
